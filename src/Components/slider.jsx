                ...
                <div className='row m-0'>
                  <div className='col-xl-3 col-lg-3 col-md-3 col-sm-4 col-5'>
                    <div className='slider-left'>
                      <div className='name'>
                        <h1>
                          Lance <br /> Toledo<span className='pc'>.</span>
                        </h1>
                      </div>
                      <div className='dash'></div>
                      <div className='social-links mb-40'>
                        <a href='https://github.com/lancetoledo'>Github</a> |{' '}
                        <a href='https://www.linkedin.com/in/lancetoledo/'>LinkedIn</a> <br />
                        <a href='https://www.youtube.com/watch?v=HMdwbq1JJT0&t=373s'>YouTube</a> |{' '}
                        <a href='https://www.instagram.com/ohitsjustlawnce/'>Instagram</a>
